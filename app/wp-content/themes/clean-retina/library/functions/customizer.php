...
function cleanretina_textarea_register($wp_customize){
	class Cleanretina_Customize_cleanretina_upgrade extends WP_Customize_Control {
		...
		<div class="theme-info">
			<a title="<?php esc_attr_e( 'Review Clean Retina', 'clean-retina' ); ?>" href="<?php echo esc_url( 'http://wordpress.org/support/view/theme-reviews/clean-retina' ); ?>" target="_blank" rel="noopener noreferrer">
			<?php _e( 'Rate Clean Retina', 'clean-retina' ); ?>
			</a>
			<a href="<?php echo esc_url( 'http://themehorse.com/theme-instruction/clean-retina/' ); ?>" title="<?php esc_attr_e( 'Clean Retina Theme Instructions', 'clean-retina' ); ?>" target="_blank" rel="noopener noreferrer">
			<?php _e( 'Theme Instructions', 'clean-retina' ); ?>
			</a>
			<a href="<?php echo esc_url( 'http://themehorse.com/support-forum/' ); ?>" title="<?php esc_attr_e( 'Support Forum', 'clean-retina' ); ?>" target="_blank" rel="noopener noreferrer">
			<?php _e( 'Support Forum', 'clean-retina' ); ?>
			</a>
			<a href="<?php echo esc_url( 'http://themehorse.com/preview/clean-retina/' ); ?>" title="<?php esc_attr_e( 'Clean Retina Demo', 'clean-retina' ); ?>" target="_blank" rel="noopener noreferrer">

...
$options = array (
	...
	array(  "name" => "Address badge on header", 
            "type" => "title",
			"desc" => "",
        ),
	...
	array( 	"name" => "Show address badge on header",
			"desc" => "",
			"id" => $shortname."_show_address",
			"std" => "false",
            "type" => "checkbox"), 		
	
	array( 	"name" => "Address",
			"desc" => "Enter the address lines. Use break tags (< br/>) to break new lines.",
    ...
    array(  "name" => "Info bar below header",
            "type" => "title",
			"desc" => "",
       		),
	...
	array( 	"name" => "Show info bar below the header",
			"desc" => "",
			"id" => $shortname."_show_infobar",
			"std" => "false",
            "type" => "checkbox"), 	
	

	array( 	"name" => "Service timings",
			"desc" => "Enter the Church service timings",
			"id" => $shortname."_service_time",
			"std" => "",
            "type" => "text"), 		

	array( 	"name" => "Church Phone",
			"desc" => "Enter the Church phone number",
			"id" => $shortname."_church_phone",
			"std" => "",
            "type" => "text"), 		

	array( 	"name" => "Church Email",
			"desc" => "Enter the Church Email",
			"id" => $shortname."_church_email",
			"std" => "",
            "type" => "text"), 					
			
	array( 	"name" => "Twitter",
			"desc" => "Enter the Church twitter",
			"id" => $shortname."_twit",
			"std" => "",
            "type" => "text"), 					
	...
	array( 	"name" => "Show the Thought of the Day section",
			"desc" => "",
			"id" => $shortname."_show_thought",
			"std" => "false",
            "type" => "checkbox"), 		
	
	array( 	"name" => "Thought of the day",
			"desc" => "One or two lines of text as thought of the day ",
			"id" => $shortname."_thought",
			"std" => "",
            "type" => "textarea"), 		
	...
	array( 	"name" => "Show about the church section",
			"desc" => "",
			"id" => $shortname."_show_about",
			"std" => "false",
            "type" => "checkbox"), 		
			
	array( 	"name" => "About title",
			"desc" => "Title for the 'About Church' section",
			"id" => $shortname."_about_title",
			"std" => "",
            "type" => "text"), 		
	
	array( 	"name" => "Image",
			"desc" => "An image in the 'About Church' section",
			"id" => $shortname."_about_image",
			"std" => get_bloginfo('template_directory')."/images/church.jpg",
            "type" => "text"), 		
	
	array( 	"name" => "About the church",
			"desc" => "A passage about the Church ",

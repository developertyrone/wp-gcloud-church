...
<div class="section-item clearfix">
	...
	<div class="content-item">
		...
		<a class="th-btn" target="_blank" rel="noopener noreferrer" href="<?php echo esc_url( 'http://themehorse.com/theme-instruction/clean-retina/' ); ?>"><?php esc_html_e('Read Full Documentation', 'clean-retina'); ?></a>
	</div>
</div>
<div class="section-item clearfix">

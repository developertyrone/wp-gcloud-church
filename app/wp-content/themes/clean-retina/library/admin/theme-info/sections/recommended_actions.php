<div class="section-item clearfix">
	...
	<div class="content-item">
		...
		<a class="th-btn" target="_blank" rel="noopener noreferrer" href="<?php echo esc_url(admin_url('post-new.php?post_type=page')); ?>"><?php esc_html_e('Create New Page', 'clean-retina'); ?></a>
	</div>
</div>
<div class="section-item clearfix">
	...
	<div class="content-item">
		...
		<a class="th-btn" target="_blank" rel="noopener noreferrer" href="<?php echo esc_url(admin_url('options-reading.php')); ?>"><?php esc_html_e('Assign Static Page', 'clean-retina'); ?></a>
	</div>
</div>
<div class="section-item clearfix">

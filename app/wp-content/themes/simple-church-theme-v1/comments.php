...
<div class="field"><input type="text" class="input" name="author" id="author" value="<?php echo $comment_author; ?>" tabindex="1" /></div>
<label for="email"><?php _e('Your Email',churchthemes); ?></label>

<div class="field"><input type="text" class="input" name="email" id="email" value="<?php echo $comment_author_email; ?>" size="22" tabindex="2" /></div>
...
<div class="textarea"><textarea name="comment" id="comment" tabindex="4" rows="" cols=""></textarea></div>
